function CerrarSesiones() {
    Swal.fire({
        position: 'center',
        html:
            '<header style="background:#2F4F4F;"><br></header>' +
            '<body>' +
            '<div class="container">' +
            ...
            '</button>' +
            '</div>' +
            '<button onClick="confirm()" style=" border:none;margin:15px; padding:10px;background: linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), #1E90FF;border-radius: 5px;">' +
            ...
            '</div>' +
            '</body>' +
            '<footer style="background:#2F4F4F"><br></footer>',
